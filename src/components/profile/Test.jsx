...
export default function Test() {
  return (
    <div>
      ...
      {/* main section  */}
      <div className="max:w-full md:flex md:flex-row flex-col-reverse justify-between px-11 mt-11 my-4">
        ...
        <div className="flx justify-center max:w-[70%] border rounded-lg px-6 py-4">
          ...
          <div className="p-4">
            ...
            <div className="mb-1">
              ...
              <div className="relative flex items-center">
                <input
                  type="text"
                  className="rounded-lg border w-[90%] px-4 py-2 focus:outline-none focus:ring-2 focus:ring-gray-400"
            ...
            <div className="max:w-[90%] flex justify-between items-center">
        ...
        <div className="max:w-[20%] h-[820px]">

          <div className="absolute top-44">

            {/* Right Top */}
            <div className="h-[820px] px-5 py-1 bg-gradient-to-t from-blue-600 to-pink-600 rounded-xl mx-auto">
              <div className="my-6">
